...
import { SelectDropdown, SelectItem } from '../components/SelectDropdown';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-16">
                ...
                <p className="text-teal-300 text-xl ml-20 mt-2">
              ...
              <div className="mb-12 max-w-md">
                ...
                <div className="flex gap-3">
                  <SelectDropdown 
                    ...
                    className="flex-1"
                  >
                    <SelectItem value="doctor" label="Doctor">
                      <div className="flex items-center gap-2">
                        <Stethoscope className="w-4 h-4 text-teal-400" />
                        <span>Doctor</span>
                      </div>
                    </SelectItem>
                    <SelectItem value="patient" label="Patient">
                      <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="bg-teal-500 hover:bg-teal-600 text-white px-8 h-12 rounded-lg shadow-lg shadow-teal-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    Continue
                  </button>
                </div>
            ...
            <div className="hidden lg:block">
              <div className="relative">
                {/* Main Image Card */}
                <div className="overflow-hidden bg-slate-800/50 border border-slate-700 backdrop-blur-sm rounded-lg shadow-sm">
                ...
                <div className="absolute -bottom-8 -right-8 w-64 bg-gradient-to-br from-teal-600 to-teal-700 border-0 shadow-2xl shadow-teal-500/30 rounded-lg">
                  <div className="p-6">
                ...
                {/* Floating OCR Card */}
                <div className="absolute -top-6 -left-6 bg-slate-800/90 border border-slate-700 backdrop-blur-sm shadow-xl rounded-lg">
